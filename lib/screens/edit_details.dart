...
import 'package:flutter_grimorio/models/personal_book.dart';
import 'package:flutter_grimorio/screens/components/date_input.dart';
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: DateInput(
                                  textController: finalDateController, label: "Final da Leitura"),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(bottom: 24.0),
                              child: TextFormField(
